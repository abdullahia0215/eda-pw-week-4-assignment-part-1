...
console.log("Test - Question 2", helloName("Dale"));
...
console.log(getLast(["tiger", "lion", "jaguar", "panther"]));
...
console.log(find(7, [2, 4, 6, 8, 10, 12]));
console.log(find(12, [2, 4, 6, 8, 10, 12]));
...
console.log(
  "is g the first letter in grab the bag?",
  isFirstLetter("g", "grab the bag")
);
console.log(
  "is p the first letter in grab the bag?",
  isFirstLetter("p", "grab the bag")
);
